...
> **Archived experiment history.** This file preserves the chronological
> v1-v6/A-D investigation, intermediate hypotheses, failed variants, commands,
> and raw evidence. It is no longer the current roadmap. Start from
> [`../mapfuse_planning_analysis.md`](../mapfuse_planning_analysis.md).
