...
# v3 best-endpoint lane-anchor blend sanity eval, alpha=0.3. This brackets the
# stronger side of the successful alpha=0.2 run.
model = dict(
    planning_head=dict(
        use_map_lane=True,
...
load_from = None
work_dir = './projects/work_dirs/stage2_e2e_lidar/base_e2e_lidar_plan_mapfuse_v3_laneanchor_bestendpoint_blend03_eval'
