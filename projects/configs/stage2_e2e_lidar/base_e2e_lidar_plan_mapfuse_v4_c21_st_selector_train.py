...
# C2.1 keeps candidate geometry discrete in the forward pass. The selected
# anchor is always one real lane candidate, while a straight-through softmax
# estimator lets planning ADE update selector logits during backpropagation.
model = dict(
    ...
    planning_head=dict(
        lane_anchor_select_mode='straight_through_selector',
