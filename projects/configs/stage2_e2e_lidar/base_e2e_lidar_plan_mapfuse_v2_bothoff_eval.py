...
# Diagnostic-eval: ego-status ablation mode='both', map ON.
...
model = dict(
    planning_head=dict(
        use_map_lane=True,
        ablate_ego_status='both',
    ))

load_from = None
work_dir = './projects/work_dirs/stage2_e2e_lidar/base_e2e_lidar_plan_mapfuse_v2_bothoff_eval'
