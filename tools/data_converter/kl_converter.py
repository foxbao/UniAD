...
from third_party.uniad_mmdet3d.core.bbox import LiDARInstance3DBoxes, box_np_ops
...
def recompute_num_lidar_pts(
    ...
    # (N,) int tensor, value in [-1, M-1]. Newer mmdet3d exposes
    # points_in_boxes_part(); this UniAD environment uses points_in_boxes().
    if hasattr(boxes3d, 'points_in_boxes_part'):
        point_box_ids = boxes3d.points_in_boxes_part(pts)
    else:
        point_box_ids = boxes3d.points_in_boxes(pts)
